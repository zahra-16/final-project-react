    ...
    return (
      <div className="text-black dark:text-white bg-white dark:bg-black font-sans min-h-screen">
        ...
        <section className="relative bg-center px-8 text-center h-[900px] flex-col">
          {videoUrl && (
            <iframe
              ...
              src={`${videoUrl}?autoplay=1&mute=1&loop=1&playlist=${
                videoUrl.split("/")[4]
              }`}
              title={movieTitle}
              frameBorder="0"
          ...
          {movie && (
            <div className="relative z-20 p-9 pt-72">
              <h1 className="text-3xl font-bold underline underline-offset-8 text-black dark:text-white ">
                {movieTitle}
              </h1>
        ...
        <section className="flex">
          <aside
            className={`bg-white dark:bg-black overflow-hidden transition-all duration-300 ${
          ...
          <main
            ...
            } bg-white dark:bg-black min-h-screen pb-28 py-3 px-8`}
          >
